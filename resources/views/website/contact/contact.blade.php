...
<div class="article">
<div class="content">
    <p>Với mục tiêu dân chủ trong nhà trường, ban giám hiệu nhà trường luôn muốn nghe những ý kiến đóng góp, phản ảnh từ phía học sinh. Mời các bạn hãy gửi các ý kiến.</p>

<p>Thông tin liên hệ</p>

<p><strong>Trường Trung học phổ thông Trần Quốc Tuấn</strong></p>

<p>Địa chỉ: 57 Huỳnh Thúc Kháng, Đống Đa, Hà Nội. Email:&nbsp;<a href="mailto:hotline@vnedu.vn">hotline@vnedu.vn</a></p>
...
<div class="contact_form">
    ...
    <form action="{{ route('website.post_createfeedback') }}" method="POST" class="comment_form">
        ...
        <div>
            <button type="submit" class="comment_button trans_200" name="btn_submit_contact">Gửi tin nhắn <i class="fa fa-paper-plane-o"></i></button>
        </div>
    </form>
</div>
</div>
