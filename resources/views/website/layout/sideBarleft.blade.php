...
<div class="item-list">
    @foreach($newsLastests as $newsLastest)
                        <div class="item">
                            <a class="title" href="{{ $newsLastest->slug_newtype .'/'.$newsLastest->slug_description }}">{{ $newsLastest->description }}</a>
                        </div>
                        @endforeach
</div>
</div>
...
<div class="item-list">
    ...
    <div class="item">
        <a class="title" href="tin-tuc{{ $newsNotification->slug_newtype .'/'.$newsNotification->slug_description }}">{{ $newsNotification->description }}</a>
    </div>
    @endforeach
        </div>
</div>
...
<div class="item-list">
    ...
    <div class="item">
        <a class="title" href="{{ $newsLinksToOrtherWebsite->slug_newtype .'/'.$newsLinksToOrtherWebsite->slug_description }}">{{ $newsLinksToOrtherWebsite->description }}</a>
    </div>
    @endforeach
    </div>
</div>
