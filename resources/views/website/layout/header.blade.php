        ...
        <div class="page-menu">
            <div id="cssmenu">
                <ul class="menu-top">
                    ...
                    <li class='item '><a href='/tin-giao-duc-do-day'>Tin tức</a>
                    <li class='item '><a href='hinh-anh'>Hình ảnh</a>
                    <li class='item '>
                    ...
                    <li class='item '><a href='#' target='_BLANK'>Xem điểm</a>
                </ul>
            </div>
